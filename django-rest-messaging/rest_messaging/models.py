...
class Thread(models.Model):
    ...
    def _limit_participants(self, request, *participants_ids):
        """ We ensure we do not have more than 10 participants. """
...
class Message(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        max_messages = getattr(settings, 'REST_MESSAGING_DAILY_LIMIT_CALLBACK', lambda message_instance, *args, **kwargs: None)(self, *args, **kwargs)  # By default, we do not filter the users who can be added to a Thread.
